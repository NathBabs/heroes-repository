    ...
    <div className="bg-white/80 backdrop-blur-sm p-6 rounded-lg shadow-md">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          <MedalMilitary weight='fill' className="w-6 h-6 text-indigo-600" />
      ...
      <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
        {isLoading ? (
          <div className="flex items-center justify-center py-8">
            <CircleNotch className="w-8 h-8 animate-spin text-indigo-600" />
          </div>
        ) : (
          <>
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <Scales weight='bold' className="w-4 h-4 text-yellow-500" />
            ...
            {superheroes.length === 0 && (
              <p className="text-center text-gray-500 py-4">
                  No superheroes added yet. Please add some superheroes to see
                  them here.
              </p>
            )}
          </>
